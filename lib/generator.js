...
Generator.prototype.generateAPI = function (apiDiscoveryUrl, callback) {
  ...
  function _generate (err, resp) {
    ...
    var templateContents2 = fs.readFileSync('./templates/urls.js', { encoding: 'utf8' });
    doIt(exportFilename2, templateContents2);


    // Functions
    var exportFilename3 = "/Users/legnitto/src/pocketship/server/rewrite/GooglePlayPocketshipShim.js";
    var templateContents3 = fs.readFileSync('./templates/functions.js', { encoding: 'utf8' });
